...
def main():
    ...
    player = Entity(int(screen_width / 2), int(screen_height / 2), '@', libtcod.dark_blue, 'Player', blocks=True, render_order=RenderOrder.ACTOR, fighter=fighter_component, inventory=inventory_component)
    entities = [player]
